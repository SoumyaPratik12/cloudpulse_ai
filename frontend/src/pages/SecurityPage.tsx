...
export const SecurityPage: React.FC = () => {
  ...
  const handleRemediate = (id: string, name: string) => {
    ...
    setTimeout(() => {
      ...
      setMessage(`Successfully remediated configuration drift for ${name}.`)
    }, 2000)
  }
  ...
  return (
    <DashboardLayout activeNavItem="security">
      <div className="space-y-lg">
        {/* Page Header */}
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Security & IAM Governance</h1>
          <p className="text-body-md text-neutral-600 dark:text-neutral-400">Manage user access configurations, security compliance checklists, and configuration drift scanning</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
          ...
          />
          <StatCard
            label="Total IAM Roles Assigned"
            value={`${team.length}`}
              ...
              <div className="flex items-center justify-between">
                ...
                {activeSecurityTab === 'drift' && (
                  <Button 
                    variant="secondary" 
                    size="sm" 
                    className="p-1 text-neutral-500 border hover:bg-slate-100 flex items-center gap-1 font-bold"
