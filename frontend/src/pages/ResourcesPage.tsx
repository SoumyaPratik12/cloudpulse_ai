...
export const ResourcesPage: React.FC = () => {
  ...
  const [instances, setInstances] = React.useState<ComputeInstance[]>([
    { id: 'i-0abcd1234efgh5678', name: 'cloudpulse-web-server-01', type: 't3.micro', region: 'ap-south-1a', cpu: 12.4, memory: 58.2, network: '4.2 MB/s', uptime: '14 days, 3h', state: 'running' },
  ...
  const [buckets, setBuckets] = React.useState<StorageBucket[]>([
    { name: 'cloudpulse-static-assets-prod', region: 'ap-south-1', objectCount: 142392, storageUsed: '824.5 GB', monthlyCost: 32.99, encryption: 'AES-256 (SSE-S3)', versioning: true, lifecycle: 'Transition to Glacier after 30 days' },
